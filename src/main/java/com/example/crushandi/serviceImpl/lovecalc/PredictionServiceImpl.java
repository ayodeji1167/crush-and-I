...
public class PredictionServiceImpl implements PredictionService {
    ...
    public ReturnedResult returnMessageForFirstAndLastAlphabet(Character firstAlphabet, Character secondAlphabet) {
        return new ReturnedResult("Wow, the first and last alphabet of you and your crush name is  the same (" + firstAlphabet.toString().toUpperCase(Locale.ROOT) + "," + secondAlphabet.toString().toUpperCase(Locale.ROOT) + ") " +
